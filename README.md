...
Elimine los objetivos, ya que solo son objetivos importantes para el desarrollo del proyecto, no son los objetivos reales en un ambiente real de producción. 
También eliminé la sección “Resultados obtenidos con los datos de prueba”. Ilustra datos que pueden ser confidenciales en un entorno de trabajo real.
Por último eliminé las “consultas de negocio” ya que no tiene relevancia según el estudio que se esté llevando a cabo sobre la base de datos. 
